...
### 🎉 Event Booking System - MBM Azure
...
✨ **Key Features:**
- 🏨 **Multi-Service Platform**: Weddings, Catering, Birthdays
- 🔒 **Military-Grade Security**: JWT authentication + role-based access
- 📊 **Admin Dashboard**: Real-time analytics & booking management
- 💅 **UI Excellence**: Micro-interactions & responsive layouts
- 📲 **PWA Ready**: Installable on mobile devices

🛠️ **Tech Stack**: Next.js | MongoDB | NextAuth | Tailwind CSS | Framer Motion
...
- Staff/student permission tiers
